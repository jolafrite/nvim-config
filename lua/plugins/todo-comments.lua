...
vim.keymap.set('n', '<leader>st', '<cmd>TodoTrouble<cr>', { desc = 'Todo (Trouble)' })
vim.keymap.set('n', '<leader>sT', '<cmd>TodoTrouble keywords=TODO,FIX,FIXME<cr>', { desc = 'Todo/Fix/Fixme (Trouble)' })
