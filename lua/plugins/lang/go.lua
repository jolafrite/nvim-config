-- Go language support (treesitter + LSP config).
--
-- go.nvim is kept for its test/format/import helpers, but `lsp_cfg = false`
-- means it does NOT start gopls itself. Register gopls here so Go files
-- get diagnostics/completion; go.nvim's own keymaps still work because
-- they call into its own functions independent of LSP.
