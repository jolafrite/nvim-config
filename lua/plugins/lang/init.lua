...
local config_only = {
  angular = true, astro = true, biome = true, clangd = true,
  dart = true, docker = true, dotnet = true, elixir = true,
  elm = true, ember = true, erlang = true, git = true, gleam = true,
  helm = true, json = true, julia = true, lua = true, markdown = true,
  nix = true, nushell = true, ocaml = true, oxc = true, php = true,
  prisma = true, python = true, rego = true, ruby = true,
  solidity = true, svelte = true, tailwind = true,
  terraform = true, toml = true, thrift = true, twig = true,
  typescript = true, typst = true, vue = true, yaml = true,
}
...
function M.load_configs()
  for _, name in ipairs {
    ...
    'dotnet', 'elixir', 'elm', 'ember', 'erlang', 'git', 'gleam',
    'helm', 'json', 'julia', 'lua', 'markdown', 'nix', 'nushell',
    'ocaml', 'oxc', 'php', 'prisma', 'python', 'rego', 'ruby',
    'solidity', 'svelte', 'tailwind', 'terraform', 'toml',
    'thrift', 'twig', 'typescript', 'typst', 'vue', 'yaml',
  } do
