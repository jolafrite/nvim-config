...
vim.keymap.set('n', '<leader>,', function() Snacks.picker.buffers() end,
	{ desc = 'Buffers' })
vim.keymap.set('n', '<leader>/', function() Snacks.picker.pick 'live_grep' end,
	{ desc = 'Grep (Root Dir)' })
vim.keymap.set('n', '<leader>:', function() Snacks.picker.command_history() end,
	{ desc = 'Command History' })
vim.keymap.set('n', '<leader><space>', function() Snacks.picker.pick 'files' end,
...
vim.keymap.set('n', '<leader>fc',
	function() Snacks.picker.pick 'config_files' end, { desc = 'Find Config File' })
vim.keymap.set('n', '<leader>ff', function() Snacks.picker.pick 'files' end,
	{ desc = 'Find Files (Root Dir)' })
vim.keymap.set('n', '<leader>fF',
	function() Snacks.picker.pick('files', { root = false }) end,
	{ desc = 'Find Files (cwd)' })
vim.keymap.set('n', '<leader>fg', function() Snacks.picker.git_files() end,
	{ desc = 'Find Files (git-files)' })
vim.keymap.set('n', '<leader>fr', function() Snacks.picker.pick 'oldfiles' end,
	{ desc = 'Recent' })
...
vim.keymap.set('n', '<leader>gS', function() Snacks.picker.git_stash() end,
	{ desc = 'Git Stash' })
vim.keymap.set('n', '<leader>gi', function() Snacks.picker.gh_issue() end,
...
vim.keymap.set('n', '<leader>sg', function() Snacks.picker.pick 'live_grep' end,
	{ desc = 'Grep (Root Dir)' })
vim.keymap.set('n', '<leader>sG',
	function() Snacks.picker.pick('live_grep', { root = false }) end,
	{ desc = 'Grep (cwd)' })
vim.keymap.set('n', '<leader>sp', function() Snacks.picker.lazy() end,
	{ desc = 'Search for Plugin Spec' })
vim.keymap.set({ 'n', 'x' }, '<leader>sw',
...
vim.keymap.set('n', '<leader>s/', function() Snacks.picker.search_history() end,
	{ desc = 'Search History' })
vim.keymap.set('n', '<leader>sa', function() Snacks.picker.autocmds() end,
	{ desc = 'Autocmds' })
vim.keymap.set('n', '<leader>sc', function() Snacks.picker.command_history() end,
	{ desc = 'Command History' })
vim.keymap.set('n', '<leader>sC', function() Snacks.picker.commands() end,
	{ desc = 'Commands' })
...
vim.keymap.set('n', '<leader>si', function() Snacks.picker.icons() end,
	{ desc = 'Icons' })
vim.keymap.set('n', '<leader>sj', function() Snacks.picker.jumps() end,
	{ desc = 'Jumps' })
...
vim.keymap.set('n', '<leader>sM', function() Snacks.picker.man() end,
	{ desc = 'Man Pages' })
vim.keymap.set('n', '<leader>sm', function() Snacks.picker.marks() end,
	{ desc = 'Marks' })
...
if vim.fn.executable 'lazygit' == 1 then
	vim.keymap.set('n', '<leader>gg',
		function() Snacks.lazygit { cwd = Snacks.git.get_root() } end,
...
vim.keymap.set('n', '<leader>gl',
	function() Snacks.picker.git_log { cwd = Snacks.git.get_root() } end,
	{ desc = 'Git Log' })
...
vim.keymap.set({ 'n', 't' }, '<c-/>',
	function() Snacks.terminal.focus(nil, { cwd = Snacks.git.get_root() }) end,
	{ desc = 'Terminal (Root Dir)' })
...
vim.api.nvim_create_autocmd('FileType', {
	...
	callback = function(ev)
		vim.keymap.set({ 'n', 'x' }, '<localleader>r',
			function() Snacks.debug.run() end, { desc = 'Run Lua', buffer = ev.buf })
	end,
})
